...
import baolilai.baolilai.util.dialog.CameraDialog;
import baolilai.baolilai.util.dialog.FileInfo;
import baolilai.baolilai.util.dialog.MyImgGridAdapter;
import baolilai.baolilai.util.image.PhotoPreviewMoreActivity;
import baolilai.baolilai.view.MyGridView;
